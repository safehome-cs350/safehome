...
from .device import Device, DeviceType, SafetyZone, SafeHomeMode, SafeHomeModeType, AlarmEvent
...
class User:
    ...
    def add_alarm_event(self, alarm_type, device_id: int | None, location: str, description: str) -> int:
    ...
    users = [
        User(
            ...
            safehome_modes={
                ...
                SafeHomeModeType.OVERNIGHT_TRAVEL: SafeHomeMode(SafeHomeModeType.OVERNIGHT_TRAVEL, [1, 2, 3]),
                SafeHomeModeType.EXTENDED_TRAVEL: SafeHomeMode(SafeHomeModeType.EXTENDED_TRAVEL, [1, 2, 3]),
                SafeHomeModeType.GUEST_HOME: SafeHomeMode(SafeHomeModeType.GUEST_HOME, [1, 2]),
            },
        )
    ]
